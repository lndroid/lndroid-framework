...
public class GetAuthRequestUser extends GetData<WalletData.User, Long> {
    public GetAuthRequestUser(IPluginClient client) {
        super(client, DefaultPlugins.GET_AUTH_REQUEST_USER);
    }
