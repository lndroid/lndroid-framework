...
public class AddListContactsPrivilege
        extends ActionBase<WalletData.ListContactsPrivilege, WalletData.ListContactsPrivilege>
{
    // plugin's Dao must extend this class
    public interface IDao extends IActionDao<WalletData.ListContactsPrivilege, WalletData.ListContactsPrivilege> {};
