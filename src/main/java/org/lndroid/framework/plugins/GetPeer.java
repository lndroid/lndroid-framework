...
public class GetPeer extends GetBase<Long> {

    // plugin's Dao must implement this
    public interface IDao extends IGetDao<WalletData.Peer> {};
    ...
    public GetPeer() {
        super(DefaultPlugins.GET_PEER, DefaultTopics.PEER_STATE);
    }
    ...
    @Override
    protected boolean isUserPrivileged(PluginContext ctx, WalletDataDecl.GetRequestTmpl<Long> req,
